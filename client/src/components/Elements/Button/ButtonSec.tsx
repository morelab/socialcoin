...
const variants = {
  primary: 'bg-indigo-500 text-white border-transparent hover:bg-indigo-600 disabled:hover:bg-indigo-500',
  inverse: 'bg-transparent text-indigo-500 border-indigo-500 hover:bg-indigo-500 hover:text-white disabled:hover:bg-transparent disabled:hover:text-indigo-500',
...
export const ButtonSec = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    {
      type = 'button',
      className = '',
